...
public class JwtService {
	...
	public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
		return Jwts.builder()
				...
				// Alterado o "sub" do "payload" do token (era o email) para o "id" do Customer
				.setSubject(userDetails.getUsername())
				// Incluso o "id" para o "token" com o "id" do Customer
	...
	// Responsável por adicionar a informação do "ID" do "Customer"!
